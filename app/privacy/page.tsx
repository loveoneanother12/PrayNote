...
export default function PrivacyPolicyPage() {
  return (
    <LegalDocument kind="privacy" eyebrow="PRIVACY POLICY" title="PrayNote 개인정보처리방침" effectiveDate="2026년 9월 16일">
      ...
      <section className="legal-section">
        ...
        <ol>
          ...
          <li><strong>푸시 알림:</strong> 웹 푸시 구독 주소와 암호화 공개키·인증값, 모바일 앱 설치 식별자, 기기별 푸시 토큰, 운영체제 및 앱 버전</li>
      ...
      <section className="legal-section">
        ...
        <ol>
          ...
          <li>기도완료 반응, 인앱 알림 및 이용자가 설정한 웹·모바일 푸시 알림 제공</li>
        ...
        <div className="legal-table-wrap">
          <table className="legal-table">
            ...
            <tbody>
              ...
              <tr><td>웹·모바일 푸시 구독 정보</td><td>해당 기기의 푸시 알림 해제 또는 회원 탈퇴 시까지</td></tr>
        ...
        <div className="legal-table-wrap">
          <table className="legal-table">
            ...
            <tbody>
              ...
              <tr><td>Google LLC (Firebase Cloud Messaging)</td><td>iOS·Android 모바일 푸시 알림 전달</td><td>알림 전달 또는 해당 기기의 푸시 토큰 삭제 시까지</td></tr>
      ...
      <section className="legal-section">
        ...
        <p>주요 서비스 실행과 데이터 저장은 대한민국 서울 리전으로 설정되어 있습니다. 다만 해외 사업자의 플랫폼 운영, 기술지원, 보안 대응 및 푸시 알림 전달 과정에서 다음과 같이 국외에서 처리되거나 접근될 수 있습니다.</p>
        <div className="legal-table-wrap wide">
          <table className="legal-table">
            ...
            <tbody>
              ...
              <tr><td>Google LLC (Firebase Cloud Messaging), Apple Inc. (APNs)</td><td>미국 등 각 제공자의 처리 국가</td><td>모바일 앱 설치 식별자, 기기별 푸시 토큰, 민감 내용을 제외한 알림 문구 / iOS·Android 푸시 알림 전달</td><td>푸시 알림 발송 시 암호화 전송 / 알림 전달 또는 해당 기기의 푸시 토큰 삭제 시까지</td></tr>
      ...
      <footer className="legal-document-footer">
          <p><strong>공고일자:</strong> 2026년 9월 16일</p>
          <p><strong>시행일자:</strong> 2026년 9월 16일</p>
